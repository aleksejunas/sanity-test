...
// node_modules/.pnpm/get-it@8.6.5/node_modules/get-it/dist/_chunks-es/_commonjsHelpers.js
...
// node_modules/.pnpm/get-it@8.6.5/node_modules/get-it/dist/index.browser.js
...
// node_modules/.pnpm/get-it@8.6.5/node_modules/get-it/dist/middleware.browser.js
function n3(e2) {
  return {};
}
var a3;
...
// node_modules/.pnpm/@sanity+client@6.24.1/node_modules/@sanity/client/dist/index.browser.js
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-SNVI36EF.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-Z3CZEUGL.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events({
    ...
    return includeDrafts && token && (esOptions.headers = {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" || esOptions.headers || esOptions.withCredentials ? (await import("./browser-Z3CZEUGL.js")).default : EventSource;
        if (unsubscribed)
          return;
        try {
          if (await fetch(url, {
